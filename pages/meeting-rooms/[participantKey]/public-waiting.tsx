...
import { getEventInfoPublic, getEventInformation, getParticipantData, getParticipantDataPublic } from '../../../services/meetingRoom.service';
...
import { IS_STARTED_MEETING } from '../../../consts/consts';
...
const PublicWaiting = () => {
  ...
  useEffect(() => {
    console.log('As loggedin user', participantkey, accessToken);
  ...
  const getEventInfo = async () => {
    if (accessToken) {
      try {
        const eventData: any = await getEventInfoPublic(accessToken, currentParticipant.eventid);
