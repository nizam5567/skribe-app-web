...
const ArchiveExhibitSection = ({ publicExhibitFound, privateExhibitFound }: IExhibitSection) => {
  ...
  return (
    <Box borderRadius={2} boxShadow={1} p={4} sx={{ 'border': '1px solid #e6e6e6', 'background': '#fff' }}>
      <Box display="flex" justifyContent={'space-between'} alignItems="center" sx={{ 'flexDirection': { 'xs': 'column-reverse', 'md': 'row' } }}>
        <Box>
          <Typography display={'inline-flex'} sx={{ 'fontSize': '20px', 'fontWeight': 400, 'lineHeight': '24px', 'color': '#3F434A' }}>
            Upload Event Exhibits
          </Typography>
        </Box>
                    ...
                    return (
                      ...
                      <Box key={exhibit.exhibitid} sx={{ 'width': '100%' }}>
                        <Box p={1} key={exhibit.exhibitid} display="flex" flexDirection={{ 'xs': 'column', 'md': 'row' }} alignItems="center" justifyContent="space-between" sx={{ 'borderBottom': '1px solid #E8E9EB', 'width': '100%' }}>
                          <Box py={1} sx={{ 'width': '30%' }} display="flex">
                            {/* <ExhibitIcon /> */}
                          ...
                          <Box py={1} sx={{ 'width': '20%' }} display="flex">
                            <Typography sx={{ 'fontSize': '14px', 'fontWeight': 400, 'lineHeight': '18px', 'color': '#3F434A' }}>{currentUserName}</Typography>
                          </Box>
                          <Box py={1} sx={{ 'width': '10%' }} display="flex" width={20}>
...
export default ArchiveExhibitSection;
