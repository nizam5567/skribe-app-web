...
import { EventStatus, MatterResponse, MattersResponse, UpdateEventRequestEventtypeEnum } from '../../../openapi/models';
        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
          {(formik) => (
              <Form onChange={(e) => handleFormOnChange(formik, e)}>
                ...
                />
                {event?.status && (event.status !== EventStatus.Archive || event.status !== EventStatus.ArchiveComplete)
                  ? (
                  <>
